...
public class TestParameterizedClass2LoginPassTest {
	
	private WebDriver driver;
	private final String email;
	private final String password;
	//private final int resultExpected;
	public TestParameterizedClass2LoginPassTest(String email, String password) {
		this.email= email;
	...
	@Parameters(name = "{index}: your input:{0}, your password is:{1}")
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {{"1st@lkjlj.com","lkjk"}, {"2nd@ljkj.com","lkjk"}, {"3rd@ljk.com","lkjlkj"}});
	}
	
	@Test
	public void testGoogleSearchOnFF() throws InterruptedException{
